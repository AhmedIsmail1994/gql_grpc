...
class HelloWorldServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserInfo = channel.unary_unary(
            '/HelloWorldService/GetUserInfo',
            request_serializer=svc__pb2.UserInfoRequest.SerializeToString,
            response_deserializer=svc__pb2.UserInfoResponse.FromString,
        )
...
def add_HelloWorldServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'SayHello': grpc.unary_unary_rpc_method_handler(
            servicer.SayHello,
            request_deserializer=svc__pb2.HelloRequest.FromString,
            response_serializer=svc__pb2.HelloResponse.SerializeToString,
        ),
        'GetUserInfo': grpc.unary_unary_rpc_method_handler(
            servicer.GetUserInfo,
            request_deserializer=svc__pb2.UserInfoRequest.FromString,
            response_serializer=svc__pb2.UserInfoResponse.SerializeToString,
        ),
    }
...
class HelloWorldService(object):
    ...
    def GetUserInfo(request,
                    ...
                    timeout=None,
                    metadata=None):
        return grpc.experimental.unary_unary(request, target, '/HelloWorldService/GetUserInfo',
                                             svc__pb2.UserInfoRequest.SerializeToString,
                                             svc__pb2.UserInfoResponse.FromString,
                                             options, channel_credentials,
                                             insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
